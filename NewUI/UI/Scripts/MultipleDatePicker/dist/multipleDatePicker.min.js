    ...
    .directive('multipleDatePicker', ['$log', function ($log) {
        ...
        return {
            ...
            scope: {
                ...
                /*
               * Type: int
               * represnt current month to be opened  default todaymonth
               * */
                currentMonth : '=' 
            },
            template: '<div class="multiple-date-picker">' +
            '<div class="picker-top-row k-header k-calendar">' +
            ...
            '<div class="text-center day dayofweek" ng-repeat="day in daysOfWeek" ng-click="toggleDayweek($event, day)" style="cursor: pointer;">{{day}}</div>' +
            '</div>' +
            ...
            link: function (scope) {
                ...
                var checkNavigationButtons = function () {
                    var today = moment(scope.currentMonth),
...
// Changed Code To Add Clear Functionality
...
//E N D
                ...
                //default values
                scope.currentMonth = scope.currentMonth || moment();
                scope.month = scope.month || moment(scope.currentMonth);
                scope.days = [];
                ...
                scope.toggleDay = function (event, momentDate) {
                    ...
                    if(scope.IsOff(momentDate)){return};
   ...
   * @callback callback deprecated
   */
                scope.toggleDayweek = function (event, momentDay) {

                 
                    event.preventDefault();
                    if (typeof scope.dayweekClick == 'function') {
                        scope.dayweekClick(event, momentDay , moment(scope.month));
                    }
                };
                ...
                scope.previousMonth = function () {
                    $('.dayofweek').removeClass('dayselected');
            ...
            var daysOffStamp = [];
            scope.daysOff.forEach(function(item) {

                daysOffStamp.push(item.getTime());
            ...
            scope.IsOff = function(day) {
                ...
                return daysOffStamp.indexOf(day._d.getTime()) != -1
            }
